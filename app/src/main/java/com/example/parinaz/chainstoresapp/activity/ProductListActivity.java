...
public class ProductListActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
   ...
   // private RecyclerView mRecyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // deleted= (Button) findViewById(R.id.deletedbtn);
      ...
      //  mRecyclerView = (RecyclerView) findViewById(R.id.product_recycler);
        ...
        productList = new ArrayList<>();
        loadProducts();
        Log.i("plog",productList.size()+"");
    //    final List<String> animalsList = new ArrayList(Arrays.asList(productList));
    ...
    public void loadProducts (){
       ...
       /* deleted.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                adapter = new ProductAdapter(productList, AppController.getInstance().getStores(), ProductListActivity.this, R.layout.product_list_item);
                adapter.removeAt(adapter.getItemCount());
